...
document.addEventListener("DOMContentLoaded", function() {
	...
	var options = {
		...
		colors: ["#4d7cff", "#51ce8a", "#733aeb", "#f2426d", "#fec801"],
		tooltip: {
			y: {
				formatter: function(val) {
					return val + "K"
...
document.addEventListener("DOMContentLoaded", function() {
	...
	var options = {
		...
		colors: ["#51ce8a", "#4d7cff", "#f2426d", "#fec801"],
		series: [44, 55, 13, 33]
	}
	var chart = new ApexCharts(
...
var options = {
        ...
        var chart = new ApexCharts(document.querySelector("#apexcharts-candlestick"), options);
        chart.render();
