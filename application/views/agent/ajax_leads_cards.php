<?php foreach ($leads as $lead): ?>
    ...
    ?>
    <div class="card lead_card_ac shadow-sm mb-4 p-3 rounded-4 <?= $statusClass; ?>" id="lead_card-<?= $lead['id'] ?>">
       <div class="lead_card_ac-header d-flex justify-content-between align-items-start mb-3 flex-wrap">
