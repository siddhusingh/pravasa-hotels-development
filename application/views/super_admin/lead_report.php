         ...
         if (disposition === "Quotation Sent" || disposition === "Contacted") {
            ...
            if (disposition === "Quotation Sent" && department === "banquets") {
               ...
               container.append(`
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-12 edit-room-required-count-field" style="${roomDateDisplay}">
                     <label class="form-label" for="edit_number_of_rooms">Number of Rooms <span class="required-marker">*</span></label>
