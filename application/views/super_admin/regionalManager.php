   ...
   <div class="container-full">
      ...
      <div class="content-header">
         <div class="d-flex align-items-center">
            <div class="me-auto">
               <h4 class="page-title">Manage Regional Managers</h4>
               <div class="d-inline-block align-items-center">
                  <nav>
                     <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                        <li class="breadcrumb-item" aria-current="page">Super Admin</li>
                        <li class="breadcrumb-item active" aria-current="page">Manage Regional Managers</li>
                     </ol>
                  </nav>
               </div>
            </div>
            ...
            <div class="col-12">
               <div class="box">
                  <div class="box-header">
                     <h4 class="box-title">Manage Regional Managers</h4>
                  ...
                  <div class="box-body">
                     <div class="table-responsive">
                        <table id="complex_header" class="text-fade table table-bordered display" style="width:100%">
                           ...
                           <tbody>
                              <?php if (!empty($regional_managers)) {
                                 $number = 1;


                                 foreach ($regional_managers as $each_regional_managers) { ?>
                                    <tr>
                                       <td><?php echo $number;
                                             $number++; ?></td>
                                       <td><?= $each_regional_managers->full_name ?></td>
                                       <td><?= $each_regional_managers->email ?></td>
                                       <td><?= $each_regional_managers->phone ?></td>
                                       <!-- <td><?= $each_regional_managers->assigned_hotels ?></td> -->
                                       <td><?= $each_regional_managers->created_at ?></td>
                                       <td><?= $each_regional_managers->updated_at ?></td>
                                       <td class="table-action min-w-100">
                                          <a href="javascript:void(0)" class="text-fade hover-primary edit" data-record_id="<?php echo $each_regional_managers->id ?>">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 align-middle">
                                                <polygon points="16 3 21 8 8 21 3 21 3 16 16 3"></polygon>
                                             </svg>
                                          </a>
                                          <a href="javascript:void(0)" class="text-fade hover-primary delete" data-record_id="<?php echo $each_regional_managers->id ?> ?>">
...
<!-- /.content-wrapper -->
<!-- Modal -->
<div class="modal  modal-lg" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="add-Regional Managers-modalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title" id="myLargeModalLabel">Add New Regional Manager</h4>
         ...
         <div class="modal-body ps-3 pe-3">
            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  <div class="mb-3">
                     <label for="username" class="form-label">Select Hotels (Multiple)</label>
                     <select class="form-control " type="text" name="hotel_id[]" id="hotel_id" multiple="">
...
<div class="modal  modal-lg" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="add-Regional Managers-modalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
         ...
         <div class="modal-body ps-3 pe-3">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="mb-3">
                     <label for="username" class="form-label">Phone</label>
                     <input class="form-control" type="number" id="phone_edit" required="" placeholder="Phones">
               ...
               <div class="col-md-12">
                  <div class="mb-3">
                     <label for="username" class="form-label">Select Hotels (Multiple)</label>
                     <select class="form-control" type="text" name="hotel_id_edit[]" id="hotel_id_edit" multiple="">
                        <option selected="" disabled="" value="">Select Hotels </option>
                        <?php foreach ($hotels as $each) { ?>
                           <option value="<?php echo $each->hotel_id ?>"><?php echo $each->hotel_name ?></option>
                        <?php
...
<script type="text/javascript">
   // add Regional Managers code start from here
   ...
   $(document).on('click', '#SaveBtn', function(e) {
      ...
      var phone = $('#phone').val();
      // Get all selected hotel IDs as an array
      var hotel_ids = $('#hotel_id').val(); // This will be an array if multiple selections are allowed



      // If hotel_ids is an array, join it into a string (you can also use JSON.stringify if needed)
      var hotel_ids_str = hotel_ids ? hotel_ids.join(',') : '';
      ...
      if (email != '' && full_name != '' && password != '' && phone != '') {
         ...
         formData.append('hotel_id', hotel_ids_str); // Send the selected hotel IDs as a comma-separated string

         $.ajax({
            url: '<?php echo base_url("insert-regional-managers") ?>',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function(response) {
               ...
               // Reload page or handle success response
               window.location.reload();
               // toastr.success('New Regional Managers has been added Successfully')
            }
         });
      }
   });
   ...
   // edit-Regional Managers function start from here
   ...
   $(".edit").click(function(e) {
      ...
      $.ajax({
         url: '<?php echo base_url('edit-regional-managers') ?>',
         type: 'post',
         dataType: 'JSON',
         data: {
            id: id
   ...
   // update Regional Managers code start from here
   ...
   $('#full_name_edit').focusout(function() {
      ...
      if (value != "") {
         ...
         $('#full_name_edit_error').html('Please Enter Regional Managers Name');
         $('#full_name_edit').val('');
      }
   ...
   $(document).on('click', '#updateBtn', function(e) {
      ...
      var hotel_ids = $('#hotel_id_edit').val();
      ...
      if (full_name != '' && email != '' && phone != '') {
         ...
         formData.append('hotel_id', hotel_ids_str);


         $.ajax({
            url: '<?php echo base_url("update-regional-managers") ?>',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
   ...
   // delete Regional Managers code is here
   ...
   $(".delete").click(function(argument) {
      Swal.fire({
         ...
         if (result.isConfirmed) {
            ...
            var id = $(this).attr('data-record_id');
            $.ajax({
               url: '<?php echo base_url('delete-regional-managers') ?>',
               method: "POST",
               data: {
                  id: id
               },
               success: function(res) {
                  ...
                  //Swal.fire("Regional Managers Has been Deleted Successfully!", "", "success");
                  window.location.reload();
