...
<style>
   /* ===================================================
   PROFILE DRAWER - ULTRA PREMIUM UI
=================================================== */
.profile-user-info{
    text-align:center;
}
.profile_drawer .modal-dialog{
    position: fixed;
    right: 0;
    top: 0;
    bottom: 0;
...
.profile_drawer .modal-content{
    ...
    box-shadow: -20px 0 60px rgba(126,90,239,.18);
}
...
.profile_drawer .modal-body::before{
    content:'';
    position:absolute;
    top:-130px;
    right:-130px;
...
.profile_drawer .btn-danger-light:hover{
    background:#000;
    color:#fff;
}
...
.profile-user-card{
    ...
    0 18px 45px rgba(126,90,239,.10);
...
background:linear-gradient(90deg,#7E5AEF,#A88BFF);
...
.profile-avatar img{
    ...
    0 12px 30px rgba(126,90,239,.25);
...
.profile_drawer .dropdown-divider{
...
0 12px 30px rgba(95, 94, 97, 0.12);
...
.profile-menu-item .me-15{
    ...
    0 12px 25px rgba(126,90,239,.25);

}

.profile-menu-item .me-15 span{

    font-size:22px;

}

.profile-menu-item .fw-500{
...
.profile_drawer .modal-body::-webkit-scrollbar{

    width:6px;

}

.profile_drawer .modal-body::-webkit-scrollbar-thumb{
...
a.btn.btn-icon.close_bnt.btn-sm.no-shadow {
    width: 46px;
}
</style>
