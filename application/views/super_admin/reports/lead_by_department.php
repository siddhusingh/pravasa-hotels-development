        ...
        <div class="custom-page-header">
            <div class="header-left">
                ...
                <div class="header-content">
                    <h2 class="header-title">Department-wise Lead Report</h2>
                    <ol class="custom-breadcrumb">
                        <li><i class="fa fa-home"></i></li><li>Super Admin</li>
                        <li><i class="fa fa-angle-right"></i></li><li>Reports</li>
                        <li><i class="fa fa-angle-right"></i></li><li class="active">Department-wise Lead Report</li>
                    </ol>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fetchLeads(reset = false) {
            ...
            $.ajax({
                url: "<?= base_url('Reports/filter_lead_by_department') ?>",
                method: "POST",
                data: filters,
                dataType: "json",
                beforeSend: function() {
