               ...
               <div class="d-inline-block align-items-center">
                  <nav>
                     <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">View Daily Sale Reports > <?php echo $hotel_data->hotel_name; ?></li>
                     </ol>
                  </nav>
               </div>
            </div>
            ...
            <div class="col-12">
               <div class="box">
                  <div class="box-header">
                     <h4 class="box-title">View Daily Sale Reports for : <?php echo $hotel_data->hotel_name; ?></h4>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="table-action min-w-100">
                                    ...
                                    <a href="<?php echo base_url('superAdmin/ManageDsr/viewDSRDetails/') ?>/<?php echo $each->reportUid ?>/<?php echo $this->uri->segment('4') ?>" class=" btn btn-primary-light hover-primary " >
