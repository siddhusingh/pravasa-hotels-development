            ...
            foreach ($forms as $each_facebook_form) { ?>
                <tr>
                    ...
                    <td class="table-action min-w-100">
                        <a href="javascript:void(0)" class="text-fade hover-primary edit-facebook_form"
                            data-record_id="<?= $each_facebook_form->id ?>">
                        ...
                        <a href="javascript:void(0)" class="text-fade hover-primary delete-facebook_form"
                            data-record_id="<?= $each_facebook_form->id ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
