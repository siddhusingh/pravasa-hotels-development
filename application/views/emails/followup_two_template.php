...
<head>
    <meta charset="UTF-8">
    <title>Second Follow-Up Reminder</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; padding:20px; border:1px solid #ddd;">
                    <tr>
                        <td style="font-size:16px; color:#333;">
                            ...
                            <p>
                                This is your second and urgent follow-up reminder for the below lead.
                                As per your selected follow-up schedule (<?php echo $lead->second_followup_date; ?>),
                                we still have not received any update from your side.
                            </p>

                            <p>
                                Timely action is important to ensure proper customer handling.
                                Kindly take immediate action and update the status.
                            </p>
                            ...
                            <p>
                                We request you to provide the follow-up update at the earliest to maintain accurate lead tracking.
                            </p>

                            <p>
                                <strong>This is urgent. Please update by:</strong>
                                <strong><?php echo $lead->followup_two_date; ?></strong>
                            </p>
