                     ...
                     <div>
                        ...
                        <div class="profile-user-card">
                           ...
                           <div class="profile-user-info">
                              <h5 class="mb-0" data-sales-profile-name><?= htmlspecialchars($profile_data->full_name ?? '', ENT_QUOTES, 'UTF-8') ?></h5>
                              <p class="my-5 text-fade">
                                 <?= htmlspecialchars($profile_data->user_role ?? '', ENT_QUOTES, 'UTF-8') ?>
                              </p>
                              <p>
                                 <a data-sales-profile-email href="mailto:<?= htmlspecialchars($profile_data->email ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                    <span class="icon-Mail-notification me-5"><span class="path1"></span><span class="path2"></span></span>
                                    <?= htmlspecialchars($profile_data->email ?? '', ENT_QUOTES, 'UTF-8') ?>
                                 </a>
                              </p>
                              <p>
                                 <a data-sales-profile-phone href="tel:<?= htmlspecialchars($profile_data->phone ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                    <span class="fa fa-phone me-5"><span class="path1"></span><span class="path2"></span></span>
                                    <?= htmlspecialchars($profile_data->phone ?? '', ENT_QUOTES, 'UTF-8') ?>
                                 </a>
                              </p>

                              <a class="btn close_bnt btn-sm mt-5" href="<?php echo base_url('sales/sign-out') ?>">
                        ...
                        <?php if ($is_sales_executive): ?>
                           <div class="profile-menu-item">
                              ...
                              <div class="d-flex flex-column fw-500">
                                 <a href="<?php echo base_url('sales/profile') ?>" class="text-dark hover-primary mb-1 fs-16">My Profile</a>
...
<script>
   ...
   window.showSalesToast = function(type, message) {
