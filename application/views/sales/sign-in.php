...
<head>
  ...
  <title><?php echo $branding->site_title ?> Sales - Log in</title>
          ...
          <div class="col-lg-5 col-md-5 col-12">
            <div class="bg-white rounded10 shadow-lg">
              <div class="content-top-agile p-20 pb-0">
                ...
                <h2 class="d-none text-primary fw-600">Hotel Admin Login</h2>
                <p class="mb-0 text-fade">Sign in to continue to the Sales Portal.</p>
              </div>
              <div class="p-40">
...
<script>
    ...
    $(function () {
        ...
        $form.on('submit', function (event) {
            ...
            $.ajax({
                url: '<?= base_url('sales/sign-in-auth'); ?>',
                type: 'POST',
                data: requestData,
                dataType: 'json',
                beforeSend: function () {
