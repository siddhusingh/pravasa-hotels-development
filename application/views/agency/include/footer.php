...
$profile_data = $this->Comman_model->get_single_record('agencies', ['id' => $login_id]);
                     ...
                     <div>
                        <div class="d-flex align-items-center mb-30">
                           ...
                           <div class="d-flex flex-column fw-500">
                              <a href="<?php echo base_url('agency-profile') ?>" class="text-dark hover-primary mb-1 fs-16">My Profile</a>
                        ...
                        <div class="d-flex align-items-center mb-30">
                           ...
                           <!-- <div class="d-flex flex-column fw-500">
                              <a href="<?php echo base_url('agency-account-settings') ?>" class="text-dark hover-success mb-1 fs-16">Settings</a>
