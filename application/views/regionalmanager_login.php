...
<head>
    ...
    <title>LMS Regional Manager - Log in </title>
...
<body class="hold-transition theme-primary bg-img" style="background: url(<?php echo base_url('assets/') ?>/crescent_login_bg.webp) center / cover no-repeat">
                    ...
                    <div class="col-lg-5 col-md-5 col-12">
                        <div class="bg-white rounded10 shadow-lg">
                            <div class="content-top-agile p-20 pb-0">
                                ...
                                <h2 class="text-primary fw-600">Regional Manager Login</h2>
...
<script>
    function proceed_to_login() {
        ...
        $.ajax({
            url: '<?= base_url('RegionalManager/login_check') ?>',
            type: 'post',
            data: {
                email: email,
                password: passsword,
