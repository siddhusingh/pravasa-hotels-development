   ...
   <div class="container-full">
      ...
      <div class="content-header">
         <div class="d-flex align-items-center">
            <div class="me-auto">
               <h4 class="page-title">Manage Room Analysis</h4>
               <div class="d-inline-block align-items-center">
                  <nav>
                     <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                        <li class="breadcrumb-item" aria-current="page">Super Admin</li>
                        <li class="breadcrumb-item active" aria-current="page">Manage Room Analysis</li>
                     </ol>
                  </nav>
               </div>
            </div>
            ...
            <div class="col-12">
               <div class="box">
                  <div class="box-header">
                     <h4 class="box-title">Manage Room Analysis</h4>
                     <div class="float-right" style="float:right;">
                        <button type="button" class="btn btn-primary-light btn-sm " id="open-room_analysis-modal">
                        Add +
                        </button>
                     </div>
                  </div>
                  <div class="box-body">
                     <div class="table-responsive">
                        <table id="complex_header" class="text-fade table table-bordered display" style="width:100%">
                           ...
                           <tbody>
                              <?php if(!empty($room_analysis)) {
                                 $number=1;
                                 
                                 
                                 foreach ($room_analysis as $each_room_analysis) { ?>
                              <tr>
                                 <td><?php echo $number; $number++; ?></td>
                                 <td><?= $each_room_analysis->room_analysis_name ?></td>
                                 <td><?= $each_room_analysis->daily_budget ?></td>
                                 <!-- <td><?= $each_room_analysis->weekly_budget ?></td> -->
                                 <td><?= $each_room_analysis->monthly_budget ?></td>
                                 <td><?= $each_room_analysis->yearly_budget ?></td>
                                 <td><?= $each_room_analysis->created_at ?></td>
                                 <td><?= $each_room_analysis->updated_at ?></td>
                                 <td class="table-action min-w-100">
                                    <a href="javascript:void(0)" class="text-fade hover-primary edit-room_analysis" data-record_id="<?php echo $each_room_analysis->room_analysis_id ?>">
                                       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 align-middle">
                                          <polygon points="16 3 21 8 8 21 3 21 3 16 16 3"></polygon>
                                       </svg>
                                    </a>
                                    <a href="javascript:void(0)" class="text-fade hover-primary delete-room_analysis" data-record_id="<?php echo $each_room_analysis->room_analysis_id ?>">
...
<!-- /.content-wrapper -->
<!-- Modal -->
<div class="modal  modal-lg" id="add-room_analysis-modal" tabindex="-1" role="dialog" aria-labelledby="add-room_analysis-modalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title" id="myLargeModalLabel">Add New Room Analysis</h4>
         ...
         <div class="modal-body ps-3 pe-3">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
               <label for="username" class="form-label">Room Analysis Name</label>
               <input class="form-control" type="email" id="room_analysis_name" required="" placeholder="">
               <span id="room_analysis_name_error" class="validation text-danger"></span>
            </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
...
<div class="modal  modal-lg" id="edit-room_analysis-modal" tabindex="-1" role="dialog" aria-labelledby="add-room_analysis-modalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title" id="myLargeModalLabel">Edit Room Analysis</h4>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
         </div>
         <div class="modal-body ps-3 pe-3">
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
               <label for="username" class="form-label">Room Analysis Name</label>
               <input class="form-control" type="email" id="room_analysis_name_edit" required="" placeholder="">
               <span id="room_analysis_name_edit_error" class="validation text-danger"></span>
...
<script>
   ...
   toastr.options = {
      ...
      <?php  if($this->session->flashdata('room_analysis_success_msg')!=""){ ?>
      
      
   
      toastr.success('<?php echo $this->session->flashdata('room_analysis_success_msg'); ?>')
   
    <?php  $this->session->set_flashdata('room_analysis_success_msg',''); } ?>
</script>
<script type="text/javascript">
   // add room_analysis code start from here
   
     $("#open-room_analysis-modal").click(function(e) {
   
     	e.preventDefault()
      
      $('#room_analysis_name').val("");
      $('#daily_budget').val("");
      $('#weekly_budget').val("");
      $('#monthly_budget').val("");
      $('#yearly_budget').val("");
     ...
     $('#add-room_analysis-modal').modal('show'); 
   });
   ...
   // validation rules
    ...
    $('#room_analysis_name').focusout(function() {
     var value = this.value;
     if (value!="") {
         $('#room_analysis_name_error').html('');
       } else {
         $('#room_analysis_name_error').html('Please Enter Room Analysis Name');
         $('#room_analysis_name').val('');
       }
   ...
   $('#room_analysis_name').trigger('focusout');
   ...
   var room_analysis_name=$('#room_analysis_name').val();
   ...
   if(room_analysis_name!=''&&daily_budget!=''&&monthly_budget!=''&&yearly_budget!=''){
   
     var formData = new FormData();
     formData.append('room_analysis_name', room_analysis_name);
   ...
   $.ajax({
             url: '<?php echo base_url("insert-room_analysis") ?>',
             type: 'POST',
             data: formData,
             processData: false,
             contentType: false,
   ...
   // edit-room_analysis function start from here
   
   $(".edit-room_analysis").click(function(e) {
   	e.preventDefault()
      
      $('#room_analysis_name_edit').val("");
      $('#daily_budget').val("");
      // $('#weekly_budget').val("");
      $('#monthly_budget').val("");
      $('#yearly_budget').val("");
   ...
   //     alert(id);
    ...
    $.ajax({
      url: '<?php echo base_url('edit-room_analysis')?>',
      type: 'post',
      dataType:'JSON',
      data: {
       id:id
       ...
       success:function(res){
         ...
         if (res){
         $("#record_id").val(id)
          $('#room_analysis_name_edit').val(res.room_analysis_name);
         ...
         $('#edit-room_analysis-modal').modal('show');         
         }
   ...
   // update room_analysis code start from here

   // validation rules
    
    $('#room_analysis_name_edit').focusout(function() {
     var value = this.value;
     if (value!="") {
         $('#room_analysis_name_edit_error').html('');
       } else {
         $('#room_analysis_name_edit_error').html('Please Enter Room Analysis Name');
         $('#room_analysis_name_edit').val('');
       }
   ...
   $('#room_analysis_name_edit').trigger('focusout');
   ...
   var room_analysis_name=$('#room_analysis_name_edit').val();
   ...
   $.ajax({
             url: '<?php echo base_url("update-room_analysis") ?>',
             type: 'POST',
             data: formData,
             processData: false,
             contentType: false,
   ...
   // delete room_analysis code is here
   
   $(".delete-room_analysis").click(function (argument) {
   Swal.fire({
   title: "Are you sure?",
   ...
   if (result.isConfirmed) {
       ...
       var id=$(this).attr('data-record_id');
   $.ajax({
      url: '<?php echo base_url('delete-room_analysis')?>',
      method:"POST",
      data: {
       id:id
     },
