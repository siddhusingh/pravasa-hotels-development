...
class Login extends CI_Controller
{
                ...
                if ($staff->status == '1') {
                    ...
                    if (!empty($hotel_list)) {
                        if (!empty($hotel_list)) {
                            ...
                            $response['redirect_url'] = 'agency-dashboard'; // Change if needed
                        } else {
    ...
    public function select_hotel()
    {
        ...
        redirect($_SERVER['HTTP_REFERER'] ?? 'agency-dashboard');
    }
    ...
    public function set_selected_hotel()
    {
        ...
        if (!empty($hotel_id)) {
            ...
            $staff_hotel_department_mapping_data = $this->Comman_model->get_single_record('staff_hotel_department_mapping', ['hotel_id' => $hotel_id, 'staff_id' => $this->session->userdata('agency_session')['id']]);
            ...
            echo json_encode([
                'status' => 'success',
                'redirect_url' => 'agency-dashboard' // typo corrected here also
            ]);
        } else {
            echo json_encode([
                'status' => 'error'
    ...
    function logout()
    {
        ...
        redirect(base_url('agency-login'));
    }
    ...
    public function change_password()
    {
        ...
        $this->load->view('agency/change_password');
    }
